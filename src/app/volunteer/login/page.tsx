...
import { ShieldAlert, Sparkles, Workflow, UserPlus } from 'lucide-react';
      ...
      >
        <div className="flex flex-col items-center border-b border-[#222] pb-6 text-center">
          ...
          <p className="text-xs text-[#666] mt-1">
            IEEE Zerone 7.0 Coordinator Access
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4 font-mono text-xs">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg bg-[#0a0a0b] border border-[#2a2a2a] px-3.5 py-2.5 text-white placeholder-gray-600 focus:border-[#00e5ff] outline-none transition-all"
            />
          </div>
          ...
          >
            {isSubmitting ? 'Authenticating...' : 'Login to Volunteer Portal'}
          </button>
        </form>
